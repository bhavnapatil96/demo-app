...
class Faculty_Form extends Component {
    ...
    save=(e)=>{
        ...
        debugger;
        this.props.registerFaculty(formdata).then((data)=>{
            if(!data.userexist && data){
                debugger;
                this.navigate(data);
                this.props.goToFaculty();
            }
            else{
                alert('Email Exist...')
            }
        ...
        return (
            <div>
                <Modal show={this.props.show} onHide={this.navigate}>
                    <Modal.Header>
                        <Modal.Title>Faculty Registration</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
...
function mapStateToProps(state) {
    debugger
    return{
        register:state.FacultyReducer.faculty
    }
}
function matchDispatchToProps(dispatch) {
    return bindActionCreators({
        registerFaculty,
        goToFaculty: () => push('/admin/faculty')
    },dispatch)

}
export default withRouter(connect(mapStateToProps,matchDispatchToProps)(Faculty_Form));
